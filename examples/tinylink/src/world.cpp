...
uint8_t Component::type() const { return m_type; }

Entity *Component::entity() { return m_entity; }

const Entity *Component::entity() const { return m_entity; }

World *Component::world() { return (m_entity ? m_entity->world() : nullptr); }

const World *Component::world() const {
  return (m_entity ? m_entity->world() : nullptr);
}

Component *Component::prev() { return m_prev; }

const Component *Component::prev() const { return m_prev; }

Component *Component::next() { return m_next; }

const Component *Component::next() const { return m_next; }
...
World *Entity::world() { return m_world; }

const World *Entity::world() const { return m_world; }

Entity *Entity::prev() { return m_prev; }

const Entity *Entity::prev() const { return m_prev; }

Entity *Entity::next() { return m_next; }

const Entity *Entity::next() const { return m_next; }

std::vector<Component *> &Entity::components() { return m_components; }

void Entity::destroy() { m_world->destroy_entity(this); }
...
Entity *World::first_entity() { return m_alive.first; }

const Entity *World::first_entity() const { return m_alive.first; }

Entity *World::last_entity() { return m_alive.last; }

const Entity *World::last_entity() const { return m_alive.last; }
...
void World::destroy(Component *component) {
  if (component && component->m_entity &&
      component->m_entity->m_world == this) {
