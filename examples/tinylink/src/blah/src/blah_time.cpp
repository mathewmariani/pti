...
void Stopwatch::reset() { start_time = Time::get_ticks(); }

u64 Stopwatch::milliseconds() const { return microseconds() / 1000; }

u64 Stopwatch::microseconds() const { return Time::get_ticks() - start_time; }
