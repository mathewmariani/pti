#pragma once
#include "../../include/blah_common.h"
#include "../../include/blah_filesystem.h"
#include "../../include/blah_vector.h"
...
// Gets the Application Window Drawing Size, in Pixels. This may differ from the
// Window Size on hi-dpi displays.
void get_draw_size(int *width, int *height);

// Returns the absolute path to the directory that the application was started
// from
const char *app_path();

// Returns the absolute path to the user directory where save data and settings
// should be stored
