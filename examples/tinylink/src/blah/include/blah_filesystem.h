...
public:
  ...
  // Reads from the File into the buffer, and returns how many bytes were
  // successfully read
  virtual size_t read(void *buffer, size_t length) = 0;

  // Writes from the buffer into the File, nd returns how many bytes were
...
// Normalizes a path (removes ../, changes \\ to /, removes redundant slashes,
// etc)
