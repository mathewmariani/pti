...
template <class T, size_t Capacity> class StackVector {
private:
...
template <class T, size_t Capacity>
inline StackVector<T, Capacity> &
StackVector<T, Capacity>::operator=(const StackVector &src) {
  clear();
...
template <class T, size_t Capacity>
inline StackVector<T, Capacity> &
StackVector<T, Capacity>::operator=(StackVector &&src) noexcept {
  clear();
...
template <class T, size_t Capacity> inline T *StackVector<T, Capacity>::data() {
  return (T *)m_buffer;
}
...
template <class T, size_t Capacity> inline T *StackVector<T, Capacity>::end() {
...
template <class T, size_t Capacity> inline T &StackVector<T, Capacity>::back() {
  BLAH_ASSERT(m_count > 0, "Index out of range");
...
template <class T, size_t Capacity> inline T StackVector<T, Capacity>::pop() {
  BLAH_ASSERT(m_count > 0, "Index out of range");
