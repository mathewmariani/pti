...
struct Color {
  ...
  constexpr Color(int rgb, float alpha)
      : r((int)(((u8)((rgb & 0xFF0000) >> 16)) * alpha)),
        ...
        b((int)(((u8)(rgb & 0x0000FF)) * alpha)), a((int)(255 * alpha)) {}
  ...
  constexpr Color(const Vec3f &vec3)
      : r((int)(vec3.x * 255)), g((int)(vec3.y * 255)), b((int)(vec3.z * 255)),
        a((int)(255)) {}

  constexpr Color(const Vec3f &vec3, float alpha)
      : r((int)(vec3.x * alpha * 255)), g((int)(vec3.y * alpha * 255)),
        b((int)(vec3.z * alpha * 255)), a((int)(alpha * 255)) {}

  constexpr Color(const Vec4f &vec4)
      : r((int)(vec4.x * 255)), g((int)(vec4.y * 255)), b((int)(vec4.z * 255)),
        a((int)(vec4.w * 255)) {}

  // Parses a Hex string in the format of "#00000000" or "0x00000000" or
  // "00000000"
  Color(const char *hex_string) : r(0), g(0), b(0), a(255) {
    auto to_hex = [](char n) {
      return ((n >= '0' && n <= '9')
                  ? (n - '0')
                  : ((n >= 'A' && n <= 'F')
  ...
  static constexpr Color from_rgba(u32 value) {
    return {(u8)((value & 0xFF000000) >> 24), (u8)((value & 0x00FF0000) >> 16),
            (u8)((value & 0x0000FF00) >> 8), (u8)((value & 0x000000FF))};
  }

  // Returns an RGB Color representation of the integer value, with Alpha = 255
  static constexpr Color from_rgb(u32 value) {
    return {(u8)((value & 0xFF0000) >> 16), (u8)((value & 0x00FF00) >> 8),
            (u8)((value & 0x0000FF))};
  }
  ...
  static constexpr Color lerp(Color a, Color b, float amount) {
    ...
    return Color(
        (u8)(a.r + (b.r - a.r) * amount), (u8)(a.g + (b.g - a.g) * amount),
        (u8)(a.b + (b.b - a.b) * amount), (u8)(a.a + (b.a - a.a) * amount));
  }

  // Multiples the Color
  constexpr Color operator*(float multiply) const {
    return Color((int)(r * multiply), (int)(g * multiply), (int)(b * multiply),
                 (int)(a * multiply));
  }
