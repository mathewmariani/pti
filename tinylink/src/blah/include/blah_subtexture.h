...
struct Subtexture {
  ...
  // is 32,32, but the original image was 64,64, the frame could be
  // -16,-16,64,64
  Rectf frame;
  ...
  Subtexture();
  Subtexture(Rectf source);
  Subtexture(Rectf source, Rectf frame);
  ...
  // returns resulting source and frame rectangles based on the provided clip
  // rectangle
  void crop_info(const Rectf &clip, Rectf *dest_source,
